    ...
    return (
        <footer className="footer-custom footer mt-5 py-3 border-top text-center text-light">
            <div className="container">
                <p className="mb-3 text-secondary">Domande? <br /> contattaci al:</p>
                ...
                <div className="social-icons mt-4">
                    <a href="https://www.facebook.com/"><i className="fab fa-facebook-f mx-2 text-primary"></i></a>
                    <a href="https://x.com/"><i className="fab fa-twitter mx-2 text-primary"></i></a>
                    <a href="https://instagram.com/"><i className="fab fa-instagram mx-2 text-primary"></i></a>
                </div>

                <p className="mt-3 text-secondary"> ® 2025 BoolBnB</p>
            </div>
        </footer>
    );
};
